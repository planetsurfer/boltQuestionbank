/*
  # Fix user creation with proper column handling

  1. Changes
    - Remove existing test users
    - Create admin and teacher users without setting generated columns
    - Set proper metadata and authentication settings
*/
