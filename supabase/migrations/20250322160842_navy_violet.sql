/*
  # Fix subject_topics table and policies

  1. Changes
    - Drop and recreate subject_topics table
    - Set up proper RLS policies for all operations
    - Add initial data
  ...
  2. Security
    ...
    - Add policies for:
      ...
      - Delete: All authenticated users can delete their topics
*/
