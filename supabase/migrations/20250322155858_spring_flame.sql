...
-- Create subject_topics table if it doesn't exist
...
-- Create RLS policies with existence check
DO $$ 
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'subject_topics' 
    AND policyname = 'Anyone can read subject topics'
  ) THEN
